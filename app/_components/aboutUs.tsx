    ...
    <div className="overflow-hidden">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              { icon: ChartBarIcon, number: "25+", text: "Years Experience", color: "from-blue-500 to-blue-700" },
              { icon: GlobeAltIcon, number: "1000+", text: "Projects Completed", color: "from-orange-500 to-red-500" },
              { icon: UserGroupIcon, number: "50+", text: "Global Partners", color: "from-green-500 to-teal-500" },
              { icon: ClockIcon, number: "24/7", text: "Support Available", color: "from-purple-500 to-pink-500" }
            ].map((stat, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -10 }}
